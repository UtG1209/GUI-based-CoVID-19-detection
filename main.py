...
class Ui_MainWindow(object):
    ...
    def trainingFunction(self):
        ...
        training_set = train_datagen.flow_from_directory('D:/IITB/Summer 2022/Data analytics/29_Covid19DetectionusingCNN/TrainingDataset',
                                                         target_size = (128, 128),
                                                         batch_size = 8,
        ...
        test_set = test_datagen.flow_from_directory('D:/IITB/Summer 2022/Data analytics/29_Covid19DetectionusingCNN/TestingDataset',
                                                    target_size = (128, 128),
                                                    batch_size = 8,
                                                    class_mode = 'categorical')
